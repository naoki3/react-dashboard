...
const Navbar = () => {
  ...
  // 全部閉じる関数（initialState が Navbar から見えないので自前で false に）
  const closeAll = () =>
    setIsClicked({ cart: false, chat: false, notification: false, userProfile: false });

  return (
    <div className="flex justify-between p-2 md:ml-6 md:mr-6 relative">

      {/* 何か開いているときだけ、背面にクリック検知用オーバーレイを出す */}
       {anyOpen && (
         <div
